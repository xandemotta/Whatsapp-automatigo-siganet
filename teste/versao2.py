...
def initialize_whatsapp():
    ...
    # Esperar um tempo maior para o usuário escanear o código QR e carregar o WhatsApp Web
    print("Escaneie o código QR do WhatsApp")
    time.sleep(25)  # Tempo suficiente para carregar e escanear o QR code
...
def send_whatsapp_message(driver, contact_name, message):
    try:
        ...
        # Reduzir o tempo de espera, uma vez que o contato carrega rapidamente
        time.sleep(2)  # Apenas o tempo necessário para garantir que o contato foi carregado
...
def send_bulk_messages(contacts_csv):
    ...
    for index, row in df.iterrows():
        ...
        # Remover tempo de espera entre as mensagens para acelerar o processo
    
    print("Todas as mensagens foram enviadas.")
    time.sleep(5)  # Pequena espera antes de fechar o navegador para garantir que tudo foi concluído
    driver.quit()
